export const JavaQuarkusRules = [
  {
    title: "Java Quarkus Framework Guidelines",
    tags: ["Java", "Quarkus", "Jakarta EE", "MicroProfile", "GraalVM", "Vert.x"],
    slug: "java-quarkus-guidelines",
    content: `You are an expert in Java programming, Quarkus framework, Jakarta EE, MicroProfile, GraalVM native builds, Vert.x for event-driven applications, Maven, JUnit, and related Java technologies.
